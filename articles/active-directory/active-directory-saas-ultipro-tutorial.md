<properties
    pageTitle="教學課程︰ Azure Active Directory 整合 Ultipro |Microsoft Azure"
    description="瞭解如何設定單一登入 Azure Active Directory 和 Ultipro 之間。"
...
# <a name="tutorial-azure-active-directory-integration-with-ultipro"></a>教學課程︰ 使用 Ultipro 的 Azure Active Directory 整合

本教學課程中的目標是以顯示您如何將整合 Ultipro 與 Azure Active Directory (Azure AD)。  
Azure AD 與整合 Ultipro 為您提供下列優點︰

- 您可以控制可存取 Ultipro Azure AD
- 您可以讓使用者能自動取得登入 Ultipro （單一登入） 至其 Azure AD 帳戶
...
若要設定 Ultipro Azure AD 整合，您需要下列項目︰
...
## <a name="adding-ultipro-from-the-gallery"></a>從圖庫新增 Ultipro
若要設定 Ultipro 整合 Azure AD，您需要從庫新增 Ultipro 到受管理的 SaaS 應用程式的清單。

**若要從圖庫新增 Ultipro，請執行下列步驟︰**
...
6. 在 [搜尋] 方塊中，輸入**Ultipro**。

    ![建立 Azure AD 測試使用者](./media/active-directory-saas-ultipro-tutorial/tutorial_ultipro_01.png)

7. 在 [結果] 窗格中，選取**Ultipro**，，然後按一下要新增應用程式**完成**。

    ![建立 Azure AD 測試使用者](./media/active-directory-saas-ultipro-tutorial/tutorial_ultipro_02.png)

##  <a name="configuring-and-testing-azure-ad-single-sign-on"></a>設定及測試 Azure AD 單一登入
本節的目標是以顯示您如何設定和使用 Ultipro 根據稱為 「 許承恩 」 的測試使用者測試 Azure AD 單一登入。

單一登入搭配使用，Azure AD 需要知道什麼對應中的使用者 Ultipro Azure AD 中的使用者。 也就是說，必須建立連結和之間的關聯 Azure AD 使用者 Ultipro 中相關的使用者。  
所指派**的使用者名稱**的值為 Ultipro**使用者名稱**的值 Azure AD 中建立此連結關聯。

若要設定及測試 Azure AD 單一登入與 Ultipro，必須完成下列建置組塊︰

1. **[Azure AD 設定單一登入](#configuring-azure-ad-single-single-sign-on)**-若要讓使用者能使用這項功能。
2. **[建立 Azure AD 測試使用者](#creating-an-azure-ad-test-user)**-Azure AD 單一登入與許承恩測試。
4. **[建立 Ultipro 測試使用者](#creating-a-ultipro-test-user)**-連結至 Azure AD 的表示她的 Ultipro 中有許承恩的對應。
5. **[指派 Azure AD 測試使用者](#assigning-the-azure-ad-test-user)**-啟用許承恩使用 Azure AD 單一登入。
5. **[測試單一登入](#testing-single-sign-on)**-驗證是否設定運作。

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD 單一登入設定

本節的目標是 Azure AD 單一登入 Azure 傳統入口網站中啟用並 Ultipro 應用程式中設定單一登入。



**若要使用 Ultipro 設定 Azure AD 單一登入，請執行下列步驟︰**

1. 在 Azure 的傳統入口網站， **Ultipro**應用程式整合在頁面上，按一下 [**設定單一登入**以開啟 [**設定單一登入**] 對話方塊。

    ![設定單一登入][6] 

2. 在**您要如何登入 Ultipro 的使用者**] 頁面上，選取**Azure AD 單一登入**，然後按 [**下一步**。
...
3. **設定應用程式設定**] 對話方塊在頁面上，執行下列步驟︰
    ...
    。 在 [登入 URL] 文字方塊中，輸入您登入您的 Ultipro 應用程式，使用下列模式的使用者所使用的 URL: **」 https://\<公司名稱\>.ultipro.com/ 」**。

    b。 按一下 [**下一步**]。

4. 在**設定單一登入 Ultipro 在**頁面上，執行下列步驟︰
...
5. 若要取得 SSO 應用程式的設定，請連絡您的 UltiPro 帳戶管理員並向他們提供下列動作︰
...
本節的目標是以建立 Ultipro 中名為許承恩使用者。 請使用 Ultipro Ultipro 帳戶中新增使用者的支援小組。 


> [AZURE.NOTE]若要手動建立的使用者，您需要連絡 Ultipro 支援小組。


### <a name="assigning-the-azure-ad-test-user"></a>指派 Azure AD 測試使用者

本節的目標是啟用許承恩 Azure 單一登入使用其存取權授與 Ultipro。

![為使用者指派][200] 

**若要指定 Ultipro 許承恩，請執行下列步驟︰**
...
當您按一下 [Access] 面板中的 [Ultipro] 方塊時，您應該取得自動登入 Ultipro 應用程式。
