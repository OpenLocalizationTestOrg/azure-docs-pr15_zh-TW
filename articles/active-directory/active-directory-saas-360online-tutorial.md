...
本節的目標是 Azure AD 單一登入 Azure 傳統入口網站中啟用和設定單一登入您 360 度線上應用程式。
...
若要取得使用者在線上建立 360 度，您需要請連絡 360 度線上支援小組透過[360online@software-innovation.com](mailto:360online@software-innovation.com)。
