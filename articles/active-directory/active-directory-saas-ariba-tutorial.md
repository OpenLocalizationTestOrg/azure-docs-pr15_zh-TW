<properties
    pageTitle="教學課程︰ Azure Active Directory 整合 Ariba |Microsoft Azure"
    description="瞭解如何設定單一登入 Azure Active Directory 和 Ariba 之間。"
...
# <a name="tutorial-azure-active-directory-integration-with-ariba"></a>教學課程︰ 使用 Ariba 的 Azure Active Directory 整合

本教學課程中的目標是以顯示您如何將整合 Ariba 與 Azure Active Directory (Azure AD)。

Azure AD 與整合 Ariba 為您提供下列優點︰

- 您可以控制可存取 Ariba Azure AD
- 您可以讓使用者能自動取得登入 Ariba （單一登入） 至其 Azure AD 帳戶
...
若要設定 Ariba Azure AD 整合，您需要下列項目︰
...
## <a name="adding-ariba-from-the-gallery"></a>從圖庫新增 Ariba
若要設定 Ariba 整合 Azure AD，必須將 Ariba 從圖庫新增至您的受管理的 SaaS 應用程式清單。

**若要從圖庫新增 Ariba，請執行下列步驟︰**
...
7. 在 [結果] 窗格中，選取**Ariba**，，然後按一下 [新增應用程式**完成**。

    ![建立 Azure AD 測試使用者](./media/active-directory-saas-ariba-tutorial/tutorial_ariba_02.png)

##  <a name="configuring-and-testing-azure-ad-single-sign-on"></a>設定及測試 Azure AD 單一登入
本節的目標是以顯示您如何設定和使用 Ariba 根據稱為 「 許承恩 」 的測試使用者測試 Azure AD 單一登入。

單一登入搭配使用，Azure AD 需要知道什麼對應中的使用者 Ariba Azure AD 中的使用者。 也就是說，必須建立連結和之間的關聯 Azure AD 使用者 Ariba 中相關的使用者。

所指派**的使用者名稱**的值為 Ariba**使用者名稱**的值 Azure AD 中建立此連結關聯。

若要設定及測試 Azure AD 單一登入與 Ariba，必須完成下列建置組塊︰

1. **[Azure AD 設定單一登入](#configuring-azure-ad-single-single-sign-on)**-若要讓使用者能使用這項功能。
2. **[建立 Azure AD 測試使用者](#creating-an-azure-ad-test-user)**-Azure AD 單一登入與許承恩測試。
4. **[建立 Ariba 測試使用者](#creating-a-ariba-test-user)**-連結至 Azure AD 的表示她的 Ariba 中有許承恩的對應。
5. **[指派 Azure AD 測試使用者](#assigning-the-azure-ad-test-user)**-啟用許承恩使用 Azure AD 單一登入。
5. **[測試單一登入](#testing-single-sign-on)**-驗證是否設定運作。

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD 單一登入設定

本節的目標是 Azure AD 單一登入 Azure 傳統入口網站中啟用並 Ariba 應用程式中設定單一登入。



**若要使用 Ariba 設定 Azure AD 單一登入，請執行下列步驟︰**

1. 在 Azure 的傳統入口網站， **Ariba**應用程式整合在頁面上，按一下 [**設定單一登入**以開啟 [**設定單一登入**] 對話方塊。

    ![設定單一登入][6] 

2. 在**您要如何登入 Ariba 的使用者**] 頁面上，選取**Azure AD 單一登入**，然後按 [**下一步**。
...
3. **設定應用程式設定**] 對話方塊在頁面上，執行下列步驟:。
    ...
    。 在 [登入 URL] 文字方塊中，輸入您登入您的 Ariba 應用程式，使用下列模式的使用者所使用的 URL: **」 https://<companyname>。 sourcing.ariba.com 」**或**」 https://<CompanyName>。 supplier.ariba.com 」**。

    b。 按一下 [**下一步**]。

4. 在**設定單一登入 Ariba 在**頁面上，執行下列步驟︰
...
5. 若要取得 SSO 應用程式的設定，請連絡透過**1-866-218-2155**Ariba 支援小組。


> [AZURE.NOTE] 請確定該使用者名稱必須符合 Azure AD 否則將無法運作的整合與系統 Ariba 中。
...
### <a name="creating-a-ariba-test-user"></a>建立 Ariba 測試使用者

本節的目標是以建立 Ariba 中名為許承恩使用者。 請使用 Ariba Ariba 系統中新增使用者的支援小組。 


> [AZURE.NOTE]若要手動建立的使用者，您需要連絡 Ariba 支援小組。


### <a name="assigning-the-azure-ad-test-user"></a>指派 Azure AD 測試使用者

本節的目標是啟用許承恩 Azure 單一登入使用其存取權授與 Ariba。

![為使用者指派][200] 

**若要指定 Ariba 許承恩，請執行下列步驟︰**
...
當您按一下 [Access] 面板中的 [Ariba] 方塊時，您應該取得自動登入 Ariba 應用程式。
