...
### <a name="customscript-extension-17"></a>CustomScript 副檔名 1.7。
...
### <a name="puppet-enterprise-agent"></a>傀儡企業代理程式。
            {
...
### <a name="eset-file-security"></a>ESET 檔案的安全性
          {
            "publisher": "ESET",
            "type": "FileSecurity",
            "typeHandlerVersion": "6.0",
...
### <a name="alert-logic-log-manager"></a>提醒邏輯記錄管理員
          {
