...
建立修復服務保存庫之後，請下載最新的代理程式，並保存庫認證，並將其儲存在方便的位置，例如 C:\Downloads。
...
在此文件中，我們要自動化備份，因為採用不已設定。 我們開始建立新的備份原則使用[新增 OBPolicy](https://technet.microsoft.com/library/hh770416.aspx)指令程式。
