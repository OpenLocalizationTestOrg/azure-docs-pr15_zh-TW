<properties
   pageTitle="SQL Data Warehouse 系統檢視 |Microsoft Azure"
   description="連結至系統的 SQL Data Warehouse 檢視內容。"
...
## <a name="sql-data-warehouse-catalog-views"></a>SQL Data Warehouse 類別目錄檢視
...
## <a name="sql-data-warehouse-dynamic-management-views-dmvs"></a>SQL Data Warehouse 動態管理檢視 (Dmv)
...
## <a name="sql-server-dmvs-applicable-to-sql-data-warehouse"></a>SQL Server Dmv 適用於 SQL Data Warehouse

下列 Dmv 適用於 SQL Data Warehouse，但必須執行連線到**主要**資料庫。

- [sys.database_service_objectives](https://msdn.microsoft.com/library/mt712619.aspx)
- [sys.dm_operation_status](https://msdn.microsoft.com/library/dn270022.aspx)
- [sys.fn_helpcollations()](https://msdn.microsoft.com/library/ms187963.aspx)

## <a name="sql-server-catalog-views"></a>SQL Server 類別目錄檢視
...
## <a name="sql-server-dmvs-available-in-sql-data-warehouse"></a>SQL Server Dmv 提供的 SQL Data Warehouse

SQL Data Warehouse 公開的 SQL Server 動態管理檢視 (Dmv)。 這些檢視中，在 SQL Data Warehouse，查詢時要報告上所執行的 SQL 資料庫的狀態。

SQL Data Warehouse 內建在 Microsoft 的 MPP 技術，因為 SQL Data Warehouse 和分析平台系統的平行資料倉庫 (PDW) 都使用相同的 [系統] 檢視。

這是為什麼每個這些 DMV 具有稱為 pdw_node_id 的特定資料行。 這是運算節點的識別碼。 在 PDW 計算節點會是架構的更強概念。 在 SQL Data Warehouse，架構倚賴更散佈。

>[AZURE.NOTE] 若要使用這些檢視下, 表所示，將名稱]，插入 「 pdw_nodes_ 」。


| 在 SQL Data Warehouse DMV 名稱 | 連結至 MSDN 上的 SQL Server TRANSACT-SQL 主題 |
| :----------------------------- | :-------------------------------------------- |
...
| sys.dm_pdw_nodes_os_dispatchers | 沒有 TRANSACT-SQL 文件。 |
...
| sys.dm_pdw_nodes_os_memory_node_access_stats | 沒有 TRANSACT-SQL 文件。 |
...
| sys.dm_pdw_nodes_os_spinlock_stats | 沒有 TRANSACT-SQL 文件。 |
...
## <a name="sql-server-2016-polybase-dmvs-available-in-sql-data-warehouse"></a>SQL Server 2016 PolyBase Dmv 提供的 SQL Data Warehouse
...
- [參數](http://msdn.microsoft.com/library/ms173796.aspx)
- [常式](https://msdn.microsoft.com/library/ms188757.aspx)
- [結構描述](https://msdn.microsoft.com/library/ms182642.aspx)
- [表格](http://msdn.microsoft.com/library/ms186224.aspx)
...
- [檢視](http://msdn.microsoft.com/library/ms181381.aspx)
